...
namespace assfire::optimizer {
    class Order {
      public:
        ...
        Order() : _id(0), _visit_duration(0), _visit_cost(0) {}

        Order(Id id, TimeWindows time_windows, GeoPoint geo_point, Duration visit_duration, Cost visit_cost)
            : _id(id),
