...
namespace assfire::optimizer {
    ...
    class GeoPoint {
      public:
        ...
        /**
         * \brief Construct a new Geo Point object representing coordinates encoded using fixed point integet format with 6 decimal places, e.g.
         * coordinates (53.3456, 65.23456) are represented as (53345600, 65234560).
         *
         ...
         */
        GeoPoint(FixedPointCoordinate lat, FixedPointCoordinate lon) : _lat(lat), _lon(lon) {}
        /**
         ...
         */
        GeoPoint(double lat, double lon) : _lat((FixedPointCoordinate)(lat * 1e6)), _lon((FixedPointCoordinate)(lon * 1e6)) {}
