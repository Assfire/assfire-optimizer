...
namespace assfire::optimizer {
    class Trip {
        public:
            ...
            Vehicle::Id vehicle_id() const {return _vehicle_id;}
            void set_vehicle_id(Vehicle::Id vehicle_id) {_vehicle_id = vehicle_id;}

            const Waypoints& waypoints() const {return _waypoints;}
            void set_waypoints(Waypoints waypoints) {_waypoints = std::move(waypoints);}
