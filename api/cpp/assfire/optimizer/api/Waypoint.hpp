...
namespace assfire::optimizer {
    class Waypoint {
        public:
            ...
            Order::Id order_id() const {return _order_id;}
            void set_order_id(Order::Id order_id) {_order_id = order_id;}

            const TimeWindow& visit_time() const {return visit_time;}
            void set_visit_time(TimeWindow visit_time) {_visit_time = std:move(visit_time);}
